...
Before any new or repeated browser execution, read and follow `instructions/project-instructions.md`, including its mandatory 120-second UI-recovery policy and measured slow-load warnings above 30 seconds. Do not finalize any **FAIL** until the expected result has been observed or polled for the full interval and final evidence has been captured at or after timeout. Historical results documented below remain unchanged.
